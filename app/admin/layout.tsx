...
function AdminLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  const getActiveTab = (): string => {
    ...
    if (pathname.startsWith("/admin/customers") || pathname.startsWith("/admin/pelanggan"))
      return "daftar-pelanggan";
    if (pathname.startsWith("/admin/blacklist")) return "blacklist";
    if (pathname.startsWith("/admin/testimonials") || pathname.startsWith("/admin/testimoni"))
      return "testimonials";
    if (pathname.startsWith("/admin/payments") || pathname.startsWith("/admin/riwayat-pembayaran"))
      return "riwayat-pembayaran";
    if (pathname.startsWith("/admin/settings") || pathname.startsWith("/admin/pengaturan"))
  ...
  return (
    <div className="min-h-screen bg-[#070A11] text-slate-100 flex selection:bg-red-600 selection:text-white">
      ...
      {/* Main Persistent Layout Container */}
      <div className="flex-1 flex flex-col min-w-0 lg:pl-64 transition-all duration-300">
        ...
        {/* Dynamic Page Content without Re-mounting Layout */}
...
export default function AdminLayout({
  ...
  return (
    <AdminProvider>
      <Suspense fallback={<div className="min-h-screen bg-[#070A11]" />}>
